  ...
  return (
    <div className="max-w-5xl">
      <header className="mb-12 border-b border-border-tech pb-8">
        <span className="font-mono text-sm text-mint-precision mb-2 block">VISUAL.04</span>
        <h1 className="font-display text-4xl md:text-5xl font-bold text-text-primary tracking-tight mb-4">Metáforas Visuales</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <motion.div 
          ...
          className="bg-surface-panel border border-mint-precision/50 rounded-lg p-6 lg:p-8"
        >
          <div className="flex items-center gap-3 mb-8 pb-4 border-b border-border-tech/50">
            <div className="h-8 w-8 rounded-full bg-mint-precision/10 flex items-center justify-center text-mint-precision">
              <Check size={20} strokeWidth={3} />
            </div>
            <h2 className="font-mono text-lg text-mint-precision font-bold">ALLOWED (Técnico)</h2>
          </div>
          
          <ul className="space-y-4">
            {allowed.map((item, idx) => (
              <li key={idx} className="flex gap-3 text-text-primary">
                <span className="text-border-tech shrink-0 mt-1">♦</span>
          ...
          {/* Mini Preview Box */}
          <div className="mt-8 p-6 bg-deep-slate border border-border-tech rounded flex flex-col items-center justify-center relative overflow-hidden h-40">
            <div className="absolute inset-0 bg-grid opacity-30"></div>
            <div className="relative z-10 flex flex-col items-center w-full gap-4">
              {/* Nodes and Connectors */}
              <div className="flex items-center gap-4">
                <div className="w-16 h-10 border border-mint-precision bg-mint-precision/5 rounded-sm flex items-center justify-center">
                ...
                <div className="w-16 h-10 border border-border-tech bg-surface-panel rounded-sm flex items-center justify-center">
                   <div className="w-2 h-2 bg-text-secondary rotate-45"></div>
                </div>
              </div>
              
              {/* Timeline with keyframes */}
              <div className="w-full max-w-[200px] h-[1px] bg-border-tech relative mt-2">
        ...
        <motion.div 
          ...
          className="bg-surface-panel border border-red-500/30 rounded-lg p-6 lg:p-8 relative overflow-hidden"
        >
          <div className="flex items-center gap-3 mb-8 pb-4 border-b border-border-tech/50 relative z-10">
            <div className="h-8 w-8 rounded-full bg-red-500/10 flex items-center justify-center text-red-400">
              <X size={20} strokeWidth={3} />
            </div>
            <h2 className="font-mono text-lg text-red-400 font-bold">FORBIDDEN (Cliché IA)</h2>
          </div>
          ...
          <div className="mt-8 p-6 bg-deep-slate border border-border-tech rounded flex items-center justify-center gap-8 relative h-40 overflow-hidden">
             
             {/* Iridiscent Gradient */}
             <div className="relative w-16 h-16 rounded-full bg-gradient-to-tr from-purple-500 via-pink-500 to-yellow-500 blur-md opacity-70 flex items-center justify-center">
                {/* Brain Icon (simulated with SVG) */}
                <svg className="w-8 h-8 text-white relative z-10 opacity-80" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div className="absolute inset-0 flex items-center justify-center z-20">
                  <div className="w-20 h-[3px] bg-red-500 -rotate-45"></div>
                </div>
             </div>
