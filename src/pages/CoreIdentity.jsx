    ...
    <>
      <A4Page className="p-8 flex flex-col justify-center">
        <header className="mb-8 border-b border-border-tech pb-6">
          <span className="font-mono text-xs text-mint-precision mb-1 block">SYS.01</span>
          <h1 className="font-display text-3xl md:text-4xl font-bold text-text-primary tracking-tight mb-2">Misión y Principios</h1>
          ...
          {principles.slice(0, 2).map((principle) => (
            <motion.div key={principle.id} variants={item} className="bg-surface-panel border border-border-tech rounded-lg p-6 hover:border-text-secondary transition-colors duration-200">
              <div className="flex items-center gap-3 mb-4 border-b border-border-tech pb-4">
                ...
                <div>
                  <span className="font-mono text-[10px] text-text-secondary tracking-widest uppercase">PRINCIPIO {principle.id}</span>
                  <h2 className="font-display font-semibold text-lg text-text-primary">{principle.title}</h2>
                </div>
              </div>
              <p className="font-body text-text-secondary leading-relaxed text-xs">
                {principle.desc}
              </p>
            </motion.div>
          ))}
      ...
      <A4Page className="p-8 flex flex-col justify-center">
        <div className="space-y-6">
          ...
          <motion.div 
            ...
            className="bg-deep-slate border border-border-tech p-6 border-l-4 border-l-cadmium-orange rounded"
          >
            <h3 className="font-mono text-xs text-cadmium-orange mb-3 tracking-widest uppercase">Tono de Voz (Brand Voice)</h3>
            <p className="font-body text-text-primary text-sm italic leading-relaxed">
